...
public class GenerateDictionary {
	...
	public static void main(String[] args){
		...
		if (ap.containsKey("inSpecies")){
			...
			if (ap.containsKey("outRegexp")){
				...
				HashMap<String,DictionaryEntry> dict = generateSpeciesDictionary(in, extraSynonymFiles, includeLineNumbers, logger);
	...
	public static HashMap<String,DictionaryEntry> generateSpeciesDictionary(File file, File[] extraSynonymFiles, boolean includeLineNumbers, Logger logger){
		logger.info("Loading NCBI taxonomy data... ");
		int numPatterns = 0;
		HashMap<String,DictionaryEntry> hashMap = new HashMap<String,DictionaryEntry>();

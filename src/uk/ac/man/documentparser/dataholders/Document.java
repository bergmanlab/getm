...
public class Document implements Serializable {
	...
	public static PreparedStatement prepareInsertStatements(Connection conn){
		return prepareInsertStatements(conn, "articles");
	}
	 ...
	 */
	public static PreparedStatement prepareInsertStatements(Connection conn, String table){
		try{
